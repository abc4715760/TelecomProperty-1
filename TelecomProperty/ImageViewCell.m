...
//        activityViewLoad.frame = CGRectMake(CGRectGetWidth(self.frame)/2+40, CGRectGetHeight(self.frame)/2+40, 20, 20);
//        NSLog(@"%f===%f",CGRectGetWidth(self.frame)/2,CGRectGetHeight(self.frame)/2);
